...
import { prependLocale, withUniformGetServerSideProps, withUniformGetStaticProps, withUniformGetStaticPaths } from '@uniformdev/canvas-next/route';
...
export const getServerSideProps = withUniformGetServerSideProps({
  // prepend the active locale to the current path for fetching the composition
  // by default Next.js does not include the locale in the path
